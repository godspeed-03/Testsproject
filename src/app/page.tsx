    ...
    <div className="flex-1 flex flex-col bg-slate-950 text-slate-100">
      ...
      <section className="flex-1 flex flex-col items-center justify-center text-center p-6 lg:p-20 relative overflow-hidden">
        ...
        <div className="z-10 max-w-4xl animate-fade-in space-y-6">
          ...
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-amber-500/10 border border-amber-500/30 text-xs sm:text-sm text-amber-400 font-bold tracking-wide">
          ...
          <p className="text-lg sm:text-xl font-medium text-amber-300 max-w-2xl mx-auto">
            Executive Study Timetable, Spaced Repetition Revision & Syllabus Suite for UPSC CSE Aspirants
          </p>

          <p className="text-sm sm:text-base text-slate-300 max-w-3xl mx-auto leading-relaxed">
            <strong className="text-white font-semibold">UPSC tracker</strong> empowers Civil Services Examination candidates to structure daily study routines, track General Studies (GS1–GS4) and Optional subject syllabus progress, automate 3-stage revision milestones (R1, R2, R3), and prevent backlogs.
          </p>

          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
            <Link href="/login" className="w-full sm:w-auto">
              <Button size="lg" className="bg-gradient-to-r from-amber-500 via-orange-600 to-amber-600 hover:from-amber-600 hover:to-orange-700 text-slate-950 font-extrabold text-base sm:text-lg px-8 py-6 rounded-xl w-full gap-2 shadow-lg shadow-amber-500/20">
            ...
            <Link href="/privacy-policy" className="w-full sm:w-auto">
              <Button variant="outline" size="lg" className="border-slate-700 text-slate-300 hover:bg-slate-800 hover:text-white text-sm sm:text-base px-6 py-6 rounded-xl w-full gap-2">
      ...
      {/* Purpose of Application Section (Google OAuth Verification Requirement) */}
      <section className="py-16 bg-slate-900/80 border-t border-b border-slate-800">
        <div className="max-w-5xl mx-auto px-6 space-y-8">
          
          <div className="text-center space-y-3">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-md bg-slate-800 text-amber-400 text-xs font-bold border border-slate-700">
            ...
            <p className="text-slate-300 text-sm sm:text-base max-w-2xl mx-auto leading-relaxed">
              <strong className="text-slate-100">UPSC tracker</strong> is a specialized, web-based study management system designed specifically for students and aspirants preparing for the Union Public Service Commission (UPSC) Civil Services Examination in India.
            </p>
          </div>
      ...
      {/* Transparency & User Data Usage Section (Mandatory for Google OAuth Verification) */}
      <section className="py-16 bg-slate-950">
        <div className="max-w-4xl mx-auto px-6">
          <div className="bg-slate-900/90 border border-slate-800 rounded-2xl p-6 sm:p-10 shadow-xl relative overflow-hidden space-y-6">
            ...
            <p className="text-slate-300 text-sm leading-relaxed">
              When you sign in to <strong className="text-white font-semibold">UPSC tracker</strong> using <strong className="text-slate-200">Google Sign-In</strong>, our application requests access strictly to your basic profile information (email address, full name, and profile picture).
            </p>

            <div className="bg-slate-950 border border-slate-800/80 rounded-xl p-5 space-y-3 text-xs sm:text-sm text-slate-300">
              ...
              <div className="flex items-start gap-2.5">
                <CheckCircle2 size={16} className="text-emerald-400 shrink-0 mt-0.5" />
                <span><strong>Limited Use Compliance:</strong> UPSC tracker adheres strictly to the <a href="https://developers.google.com/terms/api-services-user-data-policy" target="_blank" rel="noopener noreferrer" className="text-emerald-400 underline font-semibold hover:text-emerald-300">Google API Services User Data Policy</a>.</span>
              </div>
            </div>

            <div className="flex flex-wrap items-center justify-between gap-4 pt-2 border-t border-slate-800 text-xs">
              <div className="flex items-center gap-4">
                <Link href="/privacy-policy" className="text-amber-400 font-bold hover:underline">
                  Read Privacy Policy
                </Link>
                <span className="text-slate-700">•</span>
                <Link href="/terms-of-service" className="text-amber-400 font-bold hover:underline">
              ...
              <div className="flex items-center gap-1.5 text-slate-400">
                ...
                <span>Support: <a href="mailto:satyam2001anand@gmail.com" className="text-slate-200 underline">satyam2001anand@gmail.com</a></span>
              </div>
            </div>
...
function FeatureCard({ icon, title, desc }: { icon: React.ReactNode; title: string; desc: string }) {
  return (
    <Card className="bg-slate-950/80 border-slate-800 text-slate-100 transition-all duration-300 hover:-translate-y-1 hover:border-amber-500/50">
      <CardHeader>
        <div className="w-12 h-12 bg-slate-900 rounded-xl flex items-center justify-center mb-3 border border-slate-800">
          {icon}
        </div>
