      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        <div className="bg-white dark:bg-slate-900/90 border border-slate-200 dark:border-slate-800 rounded-2xl p-6 sm:p-10 mb-10 shadow-xl backdrop-blur-md relative overflow-hidden">
          ...
          <p className="text-slate-600 dark:text-slate-300 text-sm leading-relaxed mt-4 border-t border-slate-200 dark:border-slate-800/80 pt-4">
            At <strong className="text-emerald-600 dark:text-emerald-400 font-semibold">UPSC tracker</strong> (accessible via <code className="bg-slate-100 dark:bg-slate-800 px-1.5 py-0.5 rounded text-emerald-700 dark:text-emerald-300 text-xs">nxtdev.in</code> and <code className="bg-slate-100 dark:bg-slate-800 px-1.5 py-0.5 rounded text-emerald-700 dark:text-emerald-300 text-xs">test.nxtdev.in</code>), we take user privacy and data security with the utmost seriousness. This Privacy Policy discloses our data handling practices for our web application, including our integration with <strong className="text-slate-800 dark:text-slate-200">Google OAuth Sign-In</strong>.
          </p>
        </div>
        ...
        <div className="bg-emerald-500/10 dark:bg-emerald-950/40 border border-emerald-500/40 rounded-xl p-5 sm:p-6 mb-8 text-xs text-emerald-900 dark:text-emerald-200 space-y-2">
          ...
          <p className="leading-relaxed">
            <strong className="text-slate-900 dark:text-white">UPSC tracker&apos;s</strong> use and transfer to any other app of information received from Google APIs will strictly adhere to the <a href="https://developers.google.com/terms/api-services-user-data-policy" target="_blank" rel="noopener noreferrer" className="underline text-emerald-700 dark:text-emerald-300 hover:text-emerald-800 dark:hover:text-emerald-200">Google API Services User Data Policy</a>, including the <strong>Limited Use</strong> requirements.
          </p>
        </div>
        ...
        <div className="space-y-8">
          ...
          <section className="bg-white dark:bg-slate-900/60 border border-slate-200 dark:border-slate-800/80 rounded-xl p-6 sm:p-8 shadow-xs">
            ...
            <div className="grid sm:grid-cols-2 gap-4 text-xs text-slate-600 dark:text-slate-300">
              ...
              <div className="bg-slate-50 dark:bg-slate-950/80 border border-slate-200 dark:border-slate-800 p-4 rounded-lg">
                ...
                <a href="mailto:satyam2001anand@gmail.com" className="text-emerald-600 dark:text-emerald-400 font-bold text-sm hover:underline">
              ...
              <div className="bg-slate-50 dark:bg-slate-950/80 border border-slate-200 dark:border-slate-800 p-4 rounded-lg">
                ...
                <a href="https://test.nxtdev.in/tracker/agenda" className="text-slate-900 dark:text-slate-200 font-mono underline hover:text-emerald-600 dark:hover:text-emerald-300">
          ...
          <section className="bg-white dark:bg-slate-900/60 border border-slate-200 dark:border-slate-800/80 rounded-xl p-6 sm:p-8 shadow-xs">
            ...
            <ul className="space-y-2 text-xs text-slate-600 dark:text-slate-300 pl-2">
              ...
              <li className="flex items-start gap-2">
                <CheckCircle2 size={15} className="text-emerald-600 dark:text-emerald-400 shrink-0 mt-0.5" />
                <span><strong>Support & Communication:</strong> Respond to your technical inquiries or account assistance sent to <a href="mailto:satyam2001anand@gmail.com" className="text-emerald-600 dark:text-emerald-400 underline">satyam2001anand@gmail.com</a>.</span>
              </li>
            </ul>
          </section>
          ...
          <section className="bg-white dark:bg-slate-900/60 border border-slate-200 dark:border-slate-800/80 rounded-xl p-6 sm:p-8 shadow-xs">
            <div className="flex items-center gap-2.5 mb-4">
              ...
              <h2 className="text-lg font-bold text-slate-900 dark:text-slate-100">Data Protection & Zero Third-Party Sharing</h2>
            </div>
            <div className="space-y-3 text-xs text-slate-600 dark:text-slate-300">
              <div className="bg-slate-50 dark:bg-slate-950/80 border border-slate-200 dark:border-slate-800 p-4 rounded-lg flex items-start gap-3">
                ...
                <div>
                  <h3 className="font-bold text-slate-900 dark:text-slate-200 text-sm mb-1">No Selling or Renting of Data</h3>
                  <p className="text-slate-500 dark:text-slate-400 leading-relaxed">
              ...
              <div className="bg-slate-50 dark:bg-slate-950/80 border border-slate-200 dark:border-slate-800 p-4 rounded-lg flex items-start gap-3">
                ...
                <div>
                  <h3 className="font-bold text-slate-900 dark:text-slate-200 text-sm mb-1">No AI / Machine Learning Model Training</h3>
                  <p className="text-slate-500 dark:text-slate-400 leading-relaxed">
          ...
          <section className="bg-white dark:bg-slate-900/60 border border-slate-200 dark:border-slate-800/80 rounded-xl p-6 sm:p-8 shadow-xs">
            ...
            <p className="text-slate-600 dark:text-slate-300 text-sm leading-relaxed">
              We employ industry-standard administrative, technical, and physical safeguards to prevent unauthorized access, loss, or disclosure of user data. All traffic to <code className="bg-slate-100 dark:bg-slate-800 px-1 rounded text-emerald-700 dark:text-emerald-300">nxtdev.in</code> is encrypted using Transport Layer Security (TLS / HTTPS).
            </p>
          </section>
          ...
          <section className="bg-white dark:bg-slate-900/60 border border-slate-200 dark:border-slate-800/80 rounded-xl p-6 sm:p-8 shadow-xs">
            <div className="flex items-center gap-2.5 mb-4">
              ...
              <h2 className="text-lg font-bold text-slate-900 dark:text-slate-100">Data Retention & Account Deletion Rights</h2>
            </div>
            <p className="text-slate-600 dark:text-slate-300 text-sm leading-relaxed mb-4">
