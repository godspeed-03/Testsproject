...
export default function GoogleSignInButton({ text = 'signin_with' }: GoogleSignInButtonProps) {
  ...
  return (
    <div className="w-full flex flex-col items-center gap-3">
      ...
      {loading ? (
        <div className="w-full h-12 rounded-full bg-slate-800 border border-slate-700 flex items-center justify-center gap-2 text-slate-200 text-sm font-semibold animate-pulse">
        ...
        <>
          ...
          <button
            ...
            className="w-full max-w-[320px] h-11 px-4 rounded-full bg-white text-slate-900 hover:bg-slate-100 font-bold text-sm flex items-center justify-center gap-3 shadow-md border border-slate-300 transition-all hover:scale-[1.02] active:scale-95"
          >
