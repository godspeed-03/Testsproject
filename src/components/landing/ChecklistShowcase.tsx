          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div className="md:col-span-3 space-y-4">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 bg-white p-4 rounded-2xl border border-slate-200/80 shadow-2xs">
                <div>
                  <h3 className="font-black text-lg text-slate-900">Checklists & Task Notebooks</h3>
                  <p className="text-xs text-slate-500 font-medium">
                ...
                <button
                  type="button"
                  className="bg-indigo-600 text-white font-extrabold text-xs px-4 py-2.5 rounded-xl flex items-center gap-1.5 shadow-md shadow-indigo-600/20 self-start sm:self-center"
                >
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                {DEMO_CHECKLISTS.map((list) => (
                  <div
                    key={list.id}
                    className="p-5 rounded-2xl border border-slate-200/80 bg-white space-y-4 shadow-2xs flex flex-col justify-between"
                  >
                    <div className="space-y-3">
                      <div className="flex items-start justify-between gap-2">
                        <div>
                          <h4 className="font-black text-base text-slate-900">{list.title}</h4>
                    ...
                    <div className="flex items-center gap-2 pt-2 border-t border-slate-100">
                      <input
                        ...
                        className="flex-1 px-3 py-1.5 rounded-xl bg-slate-100 border border-slate-200 text-xs font-bold outline-none text-slate-700 placeholder:text-slate-400"
                      />
                      <button
                        type="button"
                        className="p-2 rounded-xl bg-indigo-600 text-white font-bold text-xs shadow-md shadow-indigo-600/20"
                      >
                        <PlusCircle size={16} />
                      </button>
                    </div>
