  ...
  return (
    <section className="py-20 bg-white dark:bg-slate-950 border-t border-slate-100 dark:border-slate-800 transition-colors">
      <div className="max-w-4xl mx-auto px-4 sm:px-6">
        <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-6 sm:p-10 shadow-xl relative overflow-hidden space-y-6">
          <div className="absolute top-0 left-0 w-full h-1.5 bg-gradient-to-r from-[#4F46E5] via-[#7C3AED] to-[#06B6D4]" />

          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl bg-violet-50 dark:bg-violet-950/60 border border-violet-200 dark:border-violet-800 flex items-center justify-center text-[#7C3AED] dark:text-violet-400">
              <Lock size={20} />
            </div>
          ...
          <p className="text-slate-600 dark:text-slate-300 text-sm leading-relaxed">
            <strong className="text-slate-900 dark:text-white font-semibold">UPSC Tracker</strong> is an executive study management
            ...
            <strong className="text-slate-800 dark:text-slate-200">Google Authentication</strong>, our application requests access strictly
            to your basic profile information (email address, full name, and avatar).
          </p>

          <div className="bg-slate-50 dark:bg-slate-800/60 border border-slate-200 dark:border-slate-700 rounded-xl p-5 space-y-3 text-xs sm:text-sm text-slate-600 dark:text-slate-300">
            ...
            <div className="flex items-start gap-2.5">
              ...
              <span>
                ...
                <a
                  ...
                  className="text-[#7C3AED] dark:text-violet-400 underline font-semibold hover:text-[#6D28D9] dark:hover:text-violet-300"
                >
          ...
          <div className="flex flex-wrap items-center justify-between gap-4 pt-2 border-t border-slate-200 dark:border-slate-800 text-xs">
            <div className="flex items-center gap-4">
              <Link href="/privacy-policy" className="text-[#7C3AED] dark:text-violet-400 font-bold hover:underline flex items-center gap-1">
                <Shield size={12} /> Read Privacy Policy
              </Link>
              <span className="text-slate-300 dark:text-slate-700">•</span>
              <Link href="/terms-of-service" className="text-[#7C3AED] dark:text-violet-400 font-bold hover:underline">
            ...
            <div className="flex items-center gap-1.5 text-slate-500 dark:text-slate-400">
              ...
              <span>
                User Support Email:{" "}
                <a href="mailto:satyam2001anand@gmail.com" className="text-slate-800 dark:text-slate-200 font-bold underline">
